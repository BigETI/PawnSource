...
SC_VDEFINE constvalue tagname_tab={NULL,"",0,NULL,0};  /* tagname table */
SC_VDEFINE constvalue libname_tab={NULL,"",0,NULL,0};  /* library table (#pragma library "..." syntax) */
...
SC_VDEFINE int pc_compat=1;    /* running in compatibility mode? */

SC_VDEFINE constvalue sc_automaton_tab={NULL,"",0,NULL,0}; /* automaton table */
SC_VDEFINE constvalue sc_state_tab={NULL,"",0,NULL,0};   /* state table */
