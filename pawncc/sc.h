...
#define sDEF_AMXSTACK 1024*1024
...
SC_VDECL int stglength;
SC_VDECL int DisableRecursion;
...
#include <string>
SC_VDECL std::unordered_set<std::string> Includes;
